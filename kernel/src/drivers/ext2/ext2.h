...
/* ext2_file.c */
long ext2_file_read(struct ext2_fs *fs, struct ext2_inode *inode, void *buf,
...
uint32_t ext2_mkdir(struct ext2_fs *fs, uint32_t parent_ino, const char *name,
                    uint32_t mode);
long ext2_file_write(struct ext2_fs *fs, struct ext2_inode *inode, uint32_t ino,
                     const void *data, size_t offset, size_t count);
int ext2_dir_add_entry(struct ext2_fs *fs, struct ext2_inode *dir,
                       uint32_t dir_ino, const char *name, uint32_t child_ino,
                       uint8_t file_type);
...
int ext2_check_inode(struct ext2_fs *fs, uint32_t ino,
                     struct ext2_inode *inode);
int ext2_check_dir(struct ext2_fs *fs, struct ext2_inode *dir, uint32_t ino);
