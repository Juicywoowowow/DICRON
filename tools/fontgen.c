/*
 * fontgen.c — Host-side bitmap font generator for DICRON.
 *
 * Generates kernel/src/console/font_data.c from hardcoded 8x16 VGA
 * CP437-style glyph data (ASCII 32–126).
 *
 * This is NOT kernel code. It uses the C standard library and runs
 * on the host machine during build time.
 *
 * Usage: ./fontgen > ../kernel/src/console/font_data.c
 */
...
static const uint8_t glyphs[GLYPH_COUNT][FONT_HEIGHT] = {
	/* 32: space */
	...
	/* 36: $ */
	{0x00,0x10,0x7C,0xD6,0xD0,0x70,0x1C,0x16,
	 0xD6,0x7C,0x10,0x00,0x00,0x00,0x00,0x00},
	/* 37: % */
	...
	/* 88: X */
	{0x00,0x00,0xC6,0xC6,0x6C,0x38,0x38,0x6C,
	 0xC6,0xC6,0xC6,0x00,0x00,0x00,0x00,0x00},
	/* 89: Y */
...
int main(void)
{
	printf("/* AUTO-GENERATED by tools/fontgen — do not edit */\n");
	printf("#include \"font.h\"\n\n");
	printf("const uint8_t font_data[%d][%d] = {\n", GLYPH_COUNT, FONT_HEIGHT);
